...
function createResultsTable(reference, query, concordancePercentage) {
    ...
    for (let x = 0; x < 3; x++) {
        ...
        for (let i = 0; i < 3; i++) {
                ...
                if (i == 0 && x == 0) {
                    ...
                    if (allele == "") {
                        ...
                        if (Object.keys(reference.loci).includes(allele)) {
                            ...
                            if (tempData != table.children[table.children.length - (x + 2)].children[alleles.indexOf(allele)].innerHTML) {
            ...
            /*if (i == 0 && x == 0) {
                tempTD = table.lastChild.appendChild(document.createElement("th"));
                tempTD.appendChild(document.createTextNode("Score")); //score column
            }*/
            if (i == 3) {
                let percentage = table.lastChild.appendChild(document.createElement('td'));
